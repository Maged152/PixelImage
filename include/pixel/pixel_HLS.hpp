...
namespace qlm
{
    ...
    public:
        Pixel() : h(0), l(0), s(0), a(max_value) {}
        Pixel(T hue, T lightness, T saturation) : h(hue), l(lightness), s(saturation), a(max_value) {}
    ...
    public:
        void Set(T hue, T lim, T sat, T alpha = max_value)
        {
            h = hue;
            s = sat;
            l = lim;
